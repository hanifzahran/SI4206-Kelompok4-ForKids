        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-xs-12">
                <div class="row text-left">
                    <div class="col-md">
                        <h4><i class="fa fa-fw fa-bullhorn"></i>My Video</h4>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-6 col-xs-12">
                                    <div class="event-item">
                                        ...
                                        <div class="event-content text-center" style="width:100% !important">
                                            <h3>{{$data->name}}</h3>
                                            <h3 class='badge badge-info'>{{ $data->category }}</h3><br><br>
                                            <a href="{{route('video.detail',$data->id)}}" class="btn-block button-default">Detail</a> 
                                        </div>
                                    </div>
                                </div>
                                @empty
